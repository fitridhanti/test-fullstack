        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                ...
                <p class="text-gray-500 text-sm">
                    Manage items, serial numbers, and assignments.
                </p>
            </div>
            <button
                @click="openModal()"
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    ...
                    >
                        ...
                        <th class="px-6 py-4 text-right last:rounded-tr-xl">
                            Action
                        </th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-100">
                    ...
                    >
                        ...
                        <td
                            class="px-6 py-4 font-mono text-xs text-blue-600 font-bold"
                        >
                        ...
                        <td class="px-6 py-4 text-right relative">
                            <button
                                ...
                                class="p-2 rounded-full hover:bg-gray-200 border border-gray-300 text-gray-500 transition focus:outline-none bg-white"
                            >
                                <svg
                            ...
                            <div
                                ...
                                class="absolute right-0 top-8 mt-1 w-36 bg-black text-white rounded-xl shadow-xl z-50 overflow-hidden origin-top-right mr-4"
                            >
                                <div class="py-1">
                                    <button
            ...
            >
                ...
                <form @submit.prevent="saveInventory" class="mt-6">
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            class="px-5 py-2.5 rounded-lg text-sm font-medium text-white shadow-md transition"
                            :class="
                                isEditing
