<template>
    <div class="flex h-screen bg-gray-50 font-sans">
        <!-- Sidebar -->
        <aside
            class="w-64 bg-white border-r border-gray-200 hidden md:block flex-shrink-0"
        >
            <div
            ...
            <nav class="mt-6 px-4 space-y-2">
                <!-- MENU MEMBER -->
                <!-- Perhatikan penggunaan <router-link> -->
                <router-link
                    to="/members"
                    class="flex items-center px-4 py-3 rounded-lg text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition-colors duration-200"
